...
- `heart-disease-classification.ipynb` — full notebook: EDA, model comparison, hyperparameter tuning (RandomizedSearchCV + GridSearchCV), evaluation (confusion matrix, ROC/AUC, classification report, cross-validated metrics), and feature importance.
